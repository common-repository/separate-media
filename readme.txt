=== Plugin Name ===
Contributors: cweavermitcs
Tags: media, access, capability, premission, role, user, security, file, image, editor
...
Separate user's media by user or role. Compatible with User Role Editor.
